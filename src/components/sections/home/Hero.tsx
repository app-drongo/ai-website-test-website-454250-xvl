...
const DEFAULT_HERO = {
  ...
  title: 'Build smarter applications with',
  titleHighlight: 'Next-Gen Technology',
  description:
    'Accelerate your development workflow with our cutting-edge platform. Deploy faster, scale effortlessly, and focus on what matters most - your code.',
  features: [
