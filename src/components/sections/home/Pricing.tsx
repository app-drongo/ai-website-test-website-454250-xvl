...
const DEFAULT_PRICING = {
  badge: 'Pricing Plans',
  mainTitle: 'Scale Your Development',
  mainTitleHighlight: 'Effortlessly',
  mainDescription:
    'Choose the perfect plan to accelerate your development workflow. Start free, upgrade as you grow, cancel anytime.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 25%',
  plan1Name: 'Developer',
  plan1Description: 'Perfect for individual developers and side projects',
  plan1Price: 'Free',
  ...
  plan3Description: 'Custom solutions for large-scale deployments',
  plan3Price: 'Custom',
  ...
  bottomDescription:
    "We work with enterprise teams to create tailored development environments that scale with your organization's unique requirements.",
