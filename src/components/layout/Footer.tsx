...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Empowering businesses with cutting-edge web solutions and innovative digital experiences. Trusted by over 10,000 companies worldwide to scale their online presence.',
  ...
  newsletterDisclaimer:
    'Get weekly insights, product updates, and exclusive developer resources. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Test Website. All rights reserved.',
  madeWithText: 'with passion by our engineering team',
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Developer Tools', href: '/tools', editableId: 'link-footer-tools' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Data Processing', href: '/compliance', editableId: 'link-footer-compliance' },
      ],
    },
  ];
